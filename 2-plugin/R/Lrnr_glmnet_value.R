...
#'      \code{\link[glmnet]{cv.glmnet}}.
#'  - \code{value = 1}: If \code{use_min == FALSE}, the provide a lambda value.
...
Lrnr_glmnet_value <- R6Class(
  classname = "Lrnr_glmnet_value",
  inherit = Lrnr_base, portable = TRUE, class = TRUE,
  public = list(
    initialize = function(lambda = NULL, type.measure = "deviance",
                          nfolds = 10, alpha = 1, nlambda = 100,
                          use_min = TRUE, value = 1, stratify_cv = FALSE, ...) {
